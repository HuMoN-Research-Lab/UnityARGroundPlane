...
public class ConditionalHideAttributeCAVE : PropertyAttribute
{
	/// <summary>
	...
	public ConditionalHideAttributeCAVE(string conditionalSourceField)
	{
	...
	public ConditionalHideAttributeCAVE(string conditionalSourceField, bool reverse)
	{
		this.ConditionalSourceField = conditionalSourceField;
		this.HideInInspector = false;
	...
	public ConditionalHideAttributeCAVE(string conditionalSourceField, bool reverse, bool hideInInspector)
	{
		this.ConditionalSourceField = conditionalSourceField;
		this.Reverse = reverse;
