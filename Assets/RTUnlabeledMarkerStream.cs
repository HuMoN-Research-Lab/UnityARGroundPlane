...
{
    public class RTUnlabeledMarkerStream : MonoBehaviour
    {
        private List<UnlabeledMarker> markerData;
        ...
        void Update()
        {
            ...
            for (int i = 0; i < markerData.Count; i++)
            {
                ...
                {
                    markers[i].name = "unlabeled";
                    markers[i].GetComponent<Renderer>().material.color = Color.green;
