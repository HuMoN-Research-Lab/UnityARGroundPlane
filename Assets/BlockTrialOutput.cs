...
public class BlockTrialOutput : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        writer = new StreamWriter("DataOutput/" + subjectID + "_BlockNumber_" + GlobalBlockNum.SelectedBlock + "_TrialOrder.csv");
        //writer.Write("[");
    ...
    public void WriteString(string s) {
        File.AppendAllText("DataOutput/" + subjectID + "_BlockNumber_" + GlobalBlockNum.SelectedBlock + "_TrialOrder.csv", s);
    }
}
